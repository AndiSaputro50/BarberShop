 ...
 */
        ...
        --blue-color: hsl(239, 100%, 49%);
        --blue-blck: hsl(239, 100%, 28%);
...
\*-----------------------------------*/
    ...
    .back-top-btn {
        ...
        bottom: 10px;
        right: 20px;
        background-color: var(--blue-blck);
        color: var(--white);
        font-size: 20px;
        padding: 10px;
        border-radius: var(--radius-5);
  ...
  -->
            ...
            <section class="section hero has-before has-bg-image" id="home" aria-label="home" style="background-image: url('<?php echo base_url('image/home_page/bg.jpg') ?>')">
                <div class="container">
                    ...
                    <p class="hero-text">
                        Our barbershop provides services that will make you more handsome and more confident with the hairstyle you have
                    </p>

                    <a href="auth/login" class="btn has-before">
                    ...
                    <ul class="grid-list">
                        ...
                        <li>
                            <div class="service-card">
                                ...
                                <p class="card-text">
                                    To satisfy our customer, we provide suitable hairstyles for man
                                </p>
                        ...
                        <li>
                            <div class="service-card">
                                ...
                                <p class="card-text">
                                    We also provide haircut stylest to make you more comfortable with your style
                                </p>
