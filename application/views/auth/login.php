                ...
                <form action="<?php echo base_url('auth/aksi_login') ?>" enctype="multipart/form-data" method="post">
                    <div class="grid grid-cols-1 md:grid-cols-1 gap-5 md:gap-8 mt-8">
                        <div class="#">
                            ...
                            <input type="email" name="email" class="w-full rounded-lg border p-2 text-sm shadow-lg" placeholder="Enter Your Email">
                        </div>
                        ...
                        <div class="#">
                            ...
                            <div class="relative">
                                <input type="password" name="password" class="w-full rounded-lg border p-2 text-sm shadow-lg" placeholder="Enter Your Password">
                    ...
                    <div class="text-center md:text-left mt-8">
                        <button class="bg-blue-600 hover:bg-blue-800 px-4 py-2 text-white uppercase rounded text-sm tracking-wider shadow-lg" type="submit">Login</button>
