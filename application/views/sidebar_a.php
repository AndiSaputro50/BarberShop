    ...
    transform md:relative md:translate-x-0 transition duration-700 ease-in-out md:justify-between md:flex md:flex-col overflow-y-auto" data-dev-hint="sidebar; px-0 for frameless; px-2 for visually inset the navigation">
        ...
        <div class="flex flex-col space-y-1" data-dev-hint="optional div for having an extra footer navigation">
            ...
            <nav data-dev-hint="main navigation">
                <a href="<?php echo base_url('admin/dashboard') ?>" class="flex items-center py-3 text-white px-4 transition duration-300 hover:bg-blue-700 no-underline gap-2" activeclass="active">
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                        <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5z" />
                    </svg>
                    <span class="text-[18px] ml-2">Dashboard</span>
                </a>
                <a href="<?php echo base_url('admin/approve') ?>" class="flex items-center py-3 text-white px-4 transition duration-300 hover:bg-blue-700 no-underline gap-2" activeclass="active">
                    ...
                    <span class="text-[18px] ml-2">Approve</span>
                </a>
                <a href="<?php echo base_url('admin/history_approve') ?>" class="flex items-center py-3 text-white px-4 transition duration-300 hover:bg-blue-700 no-underline gap-2" activeclass="active">
                    ...
                    <span class="text-[18px] ml-2">History Approve</span>
                </a>
        ...
        <a onclick="logout()" class="flex items-center py-3 text-white px-4 transition duration-300 hover:bg-blue-700 no-underline gap-2" activeclass="active">
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-door-open mt-[55vh]" viewBox="0 0 16 16">
                <path d="M8.5 10c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1" />
                <path d="M10.828.122A.5.5 0 0 1 11 .5V1h.5A1.5 1.5 0 0 1 13 2.5V15h1.5a.5.5 0 0 1 0 1h-13a.5.5 0 0 1 0-1H3V1.5a.5.5 0 0 1 .43-.495l7-1a.5.5 0 0 1 .398.117M11.5 2H11v13h1V2.5a.5.5 0 0 0-.5-.5M4 1.934V15h6V1.077z" />
            </svg>
            <span class="text-[18px] mt-[55vh] ml-2">Logout</span>
        </a>
    </aside>
